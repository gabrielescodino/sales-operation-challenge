...
RSpec.describe Sale, type: :model do
  ...
  describe '#calculate_income' do
    it 'calculates income of a sale' do
      ...
      sale = create(:sale, sales_report: sales_report, item_price: 20_000, purchase_count: 10)
      sale2 = create(:sale,sales_report: sales_report, item_price: 100, purchase_count: 0)
      sale2 = create(:sale,sales_report: sales_report, item_price: 0, purchase_count: 54_232)

      expect(sales_report.sales.calculate_income).to eq(200_000)
    end
  end
end
